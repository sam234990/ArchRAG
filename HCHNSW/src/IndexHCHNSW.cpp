...
/**************************************************************
 * IndexHCHNSW2Level implementation
 **************************************************************/

IndexHCHNSW2Level::IndexHCHNSW2Level(
        Index* quantizer,
        size_t nlist,
        int m_pq,
        int M)
        : IndexHCHNSW(new Index2Layer(quantizer, nlist, m_pq), M) {
    own_fields = true;
    is_trained = false;
}

IndexHCHNSW2Level::IndexHCHNSW2Level() = default;
...
void IndexHCHNSW2Level::search(
    ...
    if (dynamic_cast<const Index2Layer*>(storage)) {
        IndexHCHNSW::search(n, x, k, distances, labels);
...
void IndexHCHNSW2Level::flip_to_ivf() {
...
/**************************************************************
 * IndexHCHNSWCagra implementation
 **************************************************************/

IndexHCHNSWCagra::IndexHCHNSWCagra() {
    is_trained = true;
}

IndexHCHNSWCagra::IndexHCHNSWCagra(int d, int M, MetricType metric)
        : IndexHCHNSW(
                  (metric == METRIC_L2)
    ...
    FAISS_THROW_IF_NOT_MSG(
            ...
            "unsupported metric type for IndexHCHNSWCagra");
    own_fields = true;
    is_trained = true;
    init_level0 = true;
...
void IndexHCHNSWCagra::add(idx_t n, const float* x) {
    FAISS_THROW_IF_NOT_MSG(
            !base_level_only,
...
void IndexHCHNSWCagra::search(
        ...
        const SearchParameters* params) const {
    if (!base_level_only) {
        IndexHCHNSW::search(n, x, k, distances, labels, params);
    } else {
