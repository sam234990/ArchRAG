...
#     reports = []
#     community_hierarchy_df: pd.DataFrame = pd.read_csv(
#         "/home/wangshu/rag/hier_graph_rag/test/2_hierarchy.csv"
#     )
#     local_context_df: pd.DataFrame = pd.read_csv(
#         "/home/wangshu/rag/hier_graph_rag/test/2_context.csv"
#     )

#     prep_community_report_context(
#         report_df=pd.DataFrame(reports),
#         community_hierarchy_df=community_hierarchy_df,
