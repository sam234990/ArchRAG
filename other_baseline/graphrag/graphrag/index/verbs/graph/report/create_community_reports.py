...
async def create_community_reports(
    ...
    **_kwargs,
    ...
    for level in levels:
        ...
        # level_contexts.to_csv(f"/home/wangshu/rag/hier_graph_rag/test/{level}_context.csv")        
        # community_hierarchy.to_csv(f"/home/wangshu/rag/hier_graph_rag/test/{level}_hierarchy.csv")
