# The following prompts are from GraphRAG's community reports extractor.


# This prompt is used to generate a community report for a given community context.
...
GLOBAL_REDUCE_SYSTEM_PROMPT_ORI = """
---Role---
